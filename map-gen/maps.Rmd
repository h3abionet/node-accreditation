...
Let's get a few numbers. How many have attempted or indicated an upcoming node accreditation?
...
p2 <- p2 + 
  ...
  geom_point(aes(x = Longitude, y = Latitude,
               ...
               data = dplyr::filter(nodeData, Attempted > 0), size = 12, alpha = 0.8) + 
...
tot.yrs <- data.frame("Year" = 2014:2020)
...
ggplot(tmp, aes(x = Year, y = Total)) +  geom_col(aes(fill=Exercise)) +
  scale_x_continuous("Year", breaks = 2014:2020, labels=2014:2020) +
